...
@Component({
  selector: "app-echart-speed",
  templateUrl: "./echart-speed.component.html",
  styleUrls: ["./echart-speed.component.scss"]
})

export class EchartSpeedComponent implements OnInit, OnChanges {
  ...
  ngOnChanges() {
    ...
    if (this.trainData) {
      ...
      this.ylabelData.push(this.trainData["sys1_s9"]);
